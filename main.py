...
# CORS (actualiza con tu dominio final)
app.add_middleware(
    CORSMiddleware,
...
# IDs de carpetas Drive (personaliza estos IDs)
...
# Obtener credenciales (con renovación automática)
def get_credentials():
...
async def generar_plantilla(data: FormData):
    ...
    # Descargar plantilla desde Drive (OAuth)
    ...
    # Subir archivo renderizado a Drive
